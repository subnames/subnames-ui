                  ...
                  className: "bg-white rounded-lg shadow-md p-6"
                      ...
                      className: "flex items-center space-x-4 mb-6"
                          ...
                          className: "w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center"
                            ...
                            }, "Expiry at ", Utils.timestampToDate(match$1.expires).toLocaleDateString()))), description !== undefined ? React.createElement("div", {
...
function Profile(props) {
  ...
  return React.createElement("div", undefined, React.createElement(Profile$ViewProfile, {
                  profile: [
                    undefined,
                    "",
                    "",
