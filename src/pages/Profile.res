    ...
    <div className="max-w-2xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-4">
          ...
          {switch error {
          | Some(message) => <div className="text-red-500 text-sm"> {React.string(message)} </div>
          | None => React.null
          }}
          <button
            type_="submit"
  ...
  let make = (~icon: React.element, ~label: string, ~value: string) => {
    <div className="flex items-center space-x-4">
      ...
      <div className="flex-1">
        <div className="text-sm font-medium text-gray-500">{React.string(label)}</div>
        <div className="text-gray-800">{React.string(value)}</div>
      </div>
    </div>
  }
}
    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800"> {React.string(`${name}.${Constants.sld}`)} </h1>
            <div className="text-sm text-gray-500">
              {React.string("Expiry at ")}
        ...
        {switch description {
        | Some(desc) => <div className="text-gray-600 mb-6"> {React.string(desc)} </div>
        | None => React.null
        }}
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <ProfileField
          icon={
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M22.23 5.924c-.807.358-1.672.6-2.582.71a4.526 4.526 0 001.984-2.496 9.037 9.037 0 01-2.866 1.095 4.513 4.513 0 00-7.69 4.116 12.81 12.81 0 01-9.3-4.715 4.513 4.513 0 001.396 6.022 4.493 4.493 0 01-2.043-.564v.057a4.513 4.513 0 003.62 4.425 4.52 4.52 0 01-2.037.077 4.513 4.513 0 004.216 3.134 9.05 9.05 0 01-5.604 1.93c-.364 0-.724-.021-1.08-.063a12.773 12.773 0 006.92 2.029c8.3 0 12.84-6.876 12.84-12.84 0-.195-.004-.39-.013-.583a9.172 9.172 0 002.252-2.336z" />
            </svg>
          }
          label="X (Twitter)"
          value={twitter}
        ...
        <ProfileField
          icon={
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M16 8.2A4.4 4.4 0 1111.6 12.6 4.4 4.4 0 0116 8.2zM2 2v20h20V2zm18 2.8a6.8 6.8 0 01-6.78 6.8A6.8 6.8 0 014 4.8V4h16z" />
            </svg>
          }
          label="Telegram"
          value={telegram}
